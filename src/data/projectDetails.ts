export const projectDetailsData = [
  {
    ...
    approach: "To address this marketing intelligence gap, I developed a comprehensive Power BI analytics dashboard powered by Google Ads data. The solution was architected for maximum investigative flexibility and campaign optimization.",
    impact: [
      "Identified 20% improvement potential by uncovering high-performing device and keyword combinations enabling smarter budget allocation and conversion optimization",
    ...
    skills: ["Dynamic dashboard design", "KPI calculation and measurement", "UX-focused filtering and drill-downs", "Digital marketing analytics", "Business performance storytelling", "Campaign optimization analysis"],
    fullDetails: {
      problemDetails: [
  ...
  },
  {
    ...
    approach: "To address this sales optimization challenge, I developed a comprehensive, end-to-end lead scoring framework combining statistical analysis, machine learning, and business intelligence. The solution was architected for maximum predictive accuracy and business usability.",
    impact: [
    ...
    skills: ["Feature engineering & ETL", "Statistical hypothesis testing", "Machine learning model development", "Modular pipeline architecture", "Version control and reproducibility", "Predictive analytics and scoring", "Business intelligence visualization", "Stakeholder-focused problem framing"],
    fullDetails: {
      problemDetails: [
  ...
  },
  {
    ...
    approach: "To address this critical business crisis, I developed a comprehensive Power BI analytics dashboard powered by the company's claims database. The solution was architected for maximum investigative flexibility and root-cause analysis.",
    impact: [
    ...
    skills: ["Financial risk analytics", "Claims processing workflow analysis", "Agent performance tracking and accountability systems", "Dynamic dashboard design for investigative analysis", "Cross-dimensional data modeling", "Business impact quantification and storytelling", "Operational efficiency optimization"],
    fullDetails: {
      problemDetails: [
  ...
  },
  {
    ...
    intro: "End-to-end AI agentic workflow built with n8n for automated social media content creation and distribution across multiple platforms. This project highlights expertise in emerging AI agent technologies and showcases forward-thinking automation solutions with human-in-the-loop quality control.",
    problem: "Manual social media content creation and distribution was time-consuming, inconsistent, and difficult to scale across multiple platforms while maintaining quality and brand consistency.",
    approach: "Built a comprehensive AI agentic workflow using n8n, OpenAI GPT models, and social media APIs with intelligent approval workflows and human oversight to ensure quality while maximizing automation efficiency.",
    impact: [
      "Achieved significant time savings through end-to-end automation of content creation and distribution workflows",
      "Maintained scalable content production capabilities while preserving quality control through human-in-the-loop approval systems",
      "Demonstrated expertise in emerging AI agent technologies that provide competitive advantage in automation solutions",
      "Established foundation for cost-efficient, scalable content operations with universal automation potential",
      "Created future-proof automation framework applicable across various business processes and industries"
    ],
    techStack: ["n8n", "OpenAI GPT-4", "Telegram Bot API", "Social Media APIs", "AI Image Generation", "Workflow Automation"],
    skills: ["AI agent design", "Prompt engineering", "Workflow automation", "API integration", "Human-in-the-loop system design", "Process optimization", "Quality control systems", "Cross-platform automation"],
    fullDetails: {
      problemDetails: [
        "Time-consuming manual content creation processes across multiple social media platforms",
        "Inconsistent posting schedules and content quality without dedicated social media management",
        "Difficulty scaling content production while maintaining brand voice and messaging consistency",
        "Need for cost-effective solution that doesn't compromise on content quality or engagement",
        "Challenge of coordinating content distribution across different platform requirements and formats"
      ],
      approachDetails: [
        "Content Sourcing & Monitoring: Automated content discovery and trend identification systems",
        "AI-Powered Content Creation: GPT-4 integration for generating platform-specific content with brand consistency",
        "Human-in-the-Loop Approval: Telegram bot implementation for review and approval workflows before publishing",
        "Multi-Platform Publishing: Automated distribution across social media platforms with platform-specific formatting",
        "Quality Control Systems: Built-in checks and balances to ensure content meets brand standards",
        "Workflow Orchestration: n8n implementation for seamless integration between all system components",
        "API Integration: Comprehensive connection to social media platforms and AI services",
        "Intelligent Scheduling: Automated timing optimization based on platform best practices and audience engagement"
      ],
      impactDetails: []
    }
  }
